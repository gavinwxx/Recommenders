...
# Returns: pandas.DataFrame: Movie rating dataset.
def load_pandas_df(
    size="100k",
    header=None,
...
# Public API that Loads Movie info.
# Returns: pandas.DataFrame: Movie information data, such as title, genres, and release year.
def load_item_df(
    size="100k",
    local_cache_path=None,
...
# Private function that does data loading, column handling, genre parsing, year extraction
...
# only extract rating and item data
